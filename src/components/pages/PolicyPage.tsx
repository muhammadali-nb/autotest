...
const PolicyPage = () => {
	const title =
		"Политика конфиденциальности - " + process.env.REACT_APP_WEBSITE_NAME;
	const meta: MetaTags = {
	...
	return (
		<DocumentLayout
			meta={meta}
			title={title}
			documentTitle={"Политика в отношении обработки персональных данных"}>
			<DocChapter header={"1. Общие положения"}>
				<DocParagraph padded={false}>
					...
					{process.env.REACT_APP_COMPANY_NAME} (далее — Оператор).
				</DocParagraph>
			...
			<DocChapter header={"2. Основные понятия, используемые в Политике"}>
				...
				<DocParagraph prefix={"2.3."}>
					...
					сети интернет по сетевому адресу {window.location.host}.
				</DocParagraph>
				<DocParagraph prefix={"2.4."}>
					{" "}
					Информационная система персональных данных — совокупность содержащихся
					в базах данных персональных данных и обеспечивающих их обработку
					информационных технологий и технических средств.
				</DocParagraph>
				<DocParagraph prefix={"2.5."}>
					{" "}
				...
				<DocParagraph prefix={"2.10."}>
					{" "}
					Пользователь — любой посетитель веб-сайта{" "}
					<a href={window.location.origin}>{window.location.host}</a>.
				</DocParagraph>
				<DocParagraph prefix={"2.11."}>
					{" "}
