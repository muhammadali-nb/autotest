	...
	return (
		<Modal
			...
			<div className={"position-relative"}>
				<div
					className={
						"d-flex justify-content-center align-items-center end-0 top-0 position-absolute default-transition p-0 cursor-pointer text-lightgray text-hover-gray-color bg-hover-white"
					}
					style={{
						zIndex: 300,
				...
				<div
					className={
						"position-absolute bottom-0 start-0 w-100 p-px-20 d-flex justify-content-center overlay-bt"
					}>
					<div
						className={"car-images-controls w-100"}
						style={{ maxWidth: "600px" }}>
						<button
							className={"car-images-controls-btn text-white"}
							onClick={() => handleSelect(imageIndex - 1)}>
		...
		<div className={"car-images"}>
			...
			<div className={"d-none d-lg-block mb-4"}>
				<Link
					to={"/catalog"}
					className={
						"btn btn-link d-flex font-weight-medium font-size-18 align-items-center text-uppercase default-link text-hover-default"
					}
					onClick={() => navigate(-1)}>
