...
const MobileAuthPhone: React.FC<{
	...
	return (
		<div className="mobile-modal_body-auth">
			<p>
				Войдите в личный кабинет, чтобы бронировать и арендовать автомобили
				стало быстрее и удобнее
			</p>
			<div>
				<ModalTemplatePhone
...
export const MobileAuthCode: React.FC<{
	...
	return (
		<div className="mobile-modal_body-auth">
			...
			<div
				className={
					"d-flex justify-content-between mobile-modal_body-action mb-3"
				}>
				<button
					className={"site-btn small " + (!passed ? "dark" : "")}
					onClick={(e) => {
...
const MobileAuthAccount: React.FC<{
	...
	return (
		<div className="mobile-modal_body-auth">
			...
			<button
				className={
					"site-btn small mobile-modal_body-action mb-3 " +
					(!passed ? "dark" : "")
				}
...
const MobileAuthForm: React.FC<{
	...
	return (
		<>
			...
			{step === "createAccount" && (
				<MobileAuthAccount closeFunc={props.closeFunc} setStep={setStep} />
			)}
