	...
	return (
		<>
			<div className="personal-account_actions">
				<div
					className={
						"personal-account_actions-item " + (balance <= 0 ? "disabled" : "")
					}>
					<button
						className={"personal-account_actions-btn "}
						...
						<svg
							...
							<g clipPath="url(#clip0_6038_184856)">
								<path
									d="M11 1.83333L5.5 7.19919M11 1.83333L16.5 7.19919M11 1.83333L11 16.5"
									stroke="#222222"
									strokeWidth="2"
									strokeLinecap="round"
					...
					<span className="font-size-12">Вывести</span>
				</div>
				<div className="personal-account_actions-item">
					<button
						className={"personal-account_actions-btn"}
						onClick={() => handleOpen("replenish")}>
						<svg
							xmlns="http://www.w3.org/2000/svg"
							width="22"
							height="22"
							...
							<g clipPath="url(#clip0_6038_184853)">
								<path
									d="M11 16.5007L5.5 11.1348M11 16.5007L16.5 11.1348M11 16.5007L11 1.83398"
									stroke="#222222"
									strokeWidth="2"
									strokeLinecap="round"
									strokeLinejoin="round"
					...
					<span className="font-size-12">Пополнить</span>
				</div>
				<div className="personal-account_actions-item">
					<button
						className={"personal-account_actions-btn"}
					...
					<span className="font-size-12">Перевести</span>
				</div>
			</div>
			{actionOpened.opened && (
				<>
					{actionOpened.type === "withdraw" && (
						<>
							{size === "desk" ? (
								...
								<WithdrawMobile
									active={actionOpened.opened}
									setActive={setActionOpened}
									setCallActive={setCallModal}
									balance={balance}
								/>
							)}
						</>
