...
import closeIcon from '../../img/common/mobile_menu-icons/close-advance.svg'
    ...
    return (
        <div className={`mobile-menu_advance ${isShow && 'active'} `}>
            <div className='mobile-menu_advance_content'>
                ...
                <p>
                    Бронировать и арендовать автомобили и станет быстрее и удобнее
                </p>
            </div>
            <div className='mobile-menu_advance_close' onClick={() => setIsShow(false)} >
