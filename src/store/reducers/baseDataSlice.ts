...
const mockBaseState: BaseState = {
    ...
    left: {
        ...
        carcase: {
            name: "Кузов", type: "checkbox", values: [
                { id: 1, name: 'Седан' },
                { id: 2, name: 'Универсал' },
                { id: 3, name: 'Хэтчбек' },
                { id: 4, name: 'Лифтбек' },
        ...
        engine: {
            name: "Двигатель", type: "checkbox", values: [
                { id: 1, name: 'V4' },
                { id: 2, name: 'V6' },
                { id: 3, name: 'V8' },
            ]
        ...
        gearbox: {
            name: "Коробка передач", type: "checkbox", values: [
                { id: 1, name: 'Механическая' },
                { id: 2, name: 'Автоматическая' },
            ]
        },
        drive: {
            name: "Привод", type: "checkbox", values: [
                { id: 1, name: 'Передний' },
                { id: 2, name: 'Задний' },
                { id: 3, name: 'Полный' },
            ]
        ...
        fuel: {
            name: "Вид топлива", type: "checkbox", values: [
                { id: 1, name: 'Бензин' },
                { id: 2, name: 'Дизельное' },
